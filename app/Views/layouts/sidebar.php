...
<div class="sidebar-menu">
    ...
    <ul class="menu">
        ...
        <?php if (session()->get('role') === 'mandor') : ?>
            <li class="sidebar-item has-sub <?= NavigationHelper::isActive('mandor/kelola-users', 'pelaksana/kelola-tukang'); ?>">
                ...
                <ul class="submenu">
                    <li class="submenu-item <?= uri_string() == 'mandor/kelola-users' ? 'active' : ''; ?>">
                        <a href="<?= base_url('mandor/kelola-users'); ?>" class="submenu-link">Users</a>
                    </li>

                    <li class="submenu-item <?= uri_string() == 'mandor/kelola-atasan' ? 'active' : ''; ?>">
                        <a href="form-element-input-group.html" class="submenu-link">Pengawas</a>
                    </li>

                    <li class="submenu-item <?= uri_string() == 'mandor/kelola-jabatan' ? 'active' : ''; ?>">
                        <a href="form-element-select.html" class="submenu-link">Jabatan</a>
                    </li>

                    <li class="submenu-item <?= uri_string() == 'mandor/kelola-bidang' ? 'active' : ''; ?>">
                        <a href="form-element-radio.html" class="submenu-link">Bidang</a>
                    </li>
                </ul>
            </li>
        <?php endif ?>
        ...
        <?php if (session()->get('role') === 'pelaksana') : ?>
            <li class="sidebar-item has-sub <?= NavigationHelper::isActive('pelaksana/kelola-tukang'); ?>">
                <a href="#" class="sidebar-link">
                    <i class="bi bi-hexagon-fill"></i>
                    <span>Kelola Data</span>
                </a>
                ...
                <ul class="submenu">
                    <li class="submenu-item <?= uri_string() == 'pelaksana/kelola-tukang' ? 'active' : ''; ?>">
                        <a href="<?= base_url('pelaksana/kelola-tukang'); ?>" class="submenu-link">Tukang</a>
                    </li>
                </ul>
            </li>
        <?php endif ?>
